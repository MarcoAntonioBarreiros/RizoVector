...
const PRESETS=Object.freeze({
 spark:{shape:'streak',speed:[245,520],life:[.82,1.28],radius:[1.2,2.5],length:[15,32],width:[.8,1.7],gravity:[4,34],turn:[-.28,.28],fadePower:[.85,1.15],fadeStart:[.34,.46],drag:[.986,.994],glow:[.72,1]},
 bloom:{shape:'orb',speed:[70,175],life:[1.45,2.25],radius:[2.4,4.8],length:[0,0],width:[0,0],gravity:[-18,18],turn:[-.55,.55],fadePower:[.75,1.05],fadeStart:[.48,.64],drag:[.982,.991],glow:[.75,1.05],grow:[.45,1.1]},
 vortex:{shape:'arc',speed:[115,235],life:[1.55,2.45],radius:[1.6,3.1],length:[18,36],width:[1.1,2.2],gravity:[-6,10],turn:[2.4,4.3],fadePower:[.82,1.1],fadeStart:[.42,.58],drag:[.988,.995],glow:[.8,1.1]},
 spiral:{shape:'spiral',speed:[82,165],life:[1.8,2.75],radius:[1.8,3.3],length:[20,39],width:[1,2],gravity:[-12,12],turn:[1.5,2.7],fadePower:[.78,1.02],fadeStart:[.48,.64],drag:[.989,.996],glow:[.82,1.15]},
 filament:{shape:'ribbon',speed:[145,320],life:[1.15,1.9],radius:[1.3,2.6],length:[24,48],width:[.9,1.9],gravity:[-5,30],turn:[-.9,.9],fadePower:[.82,1.08],fadeStart:[.38,.52],drag:[.986,.994],glow:[.72,1.02]},
 shatter:{shape:'shard',speed:[190,385],life:[1.05,1.72],radius:[1.7,3.4],length:[13,29],width:[1.1,2.5],gravity:[34,96],turn:[-.55,.55],fadePower:[.9,1.18],fadeStart:[.34,.48],drag:[.984,.992],glow:[.7,1]},
 spore:{shape:'orb',speed:[30,92],life:[1.9,3.05],radius:[1.8,3.5],length:[0,0],width:[0,0],gravity:[-18,10],turn:[-.4,.4],fadePower:[.72,.98],fadeStart:[.55,.72],drag:[.991,.997],glow:[.7,1],grow:[.15,.5],motion:'wobble'},
 dissolve:{shape:'cloud',speed:[9,42],life:[2.15,3.35],radius:[4.8,10.5],length:[0,0],width:[0,0],gravity:[-28,-6],turn:[-.25,.25],fadePower:[1.05,1.45],fadeStart:[.82,.94],drag:[.988,.995],glow:[.5,.8],grow:[1.2,2.3]}
});
...
export function createParticle(presetName,x,y,color,options={}){
 ...
 return{
  ...
  blend:options.blend??'add',alpha:options.alpha??1,length,width,turnRate:turnDirection*turnMagnitude,spin:Math.random()*TAU,spinSpeed:rand(-5.5,5.5),curve:rand(-.72,.72),
