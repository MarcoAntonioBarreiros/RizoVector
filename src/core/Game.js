...
export class Game{
 ...
 updateObjects(dt){this.projectiles.forEachActive(b=>{b.x+=b.vx*dt;b.y+=b.vy*dt;b.life-=dt;if(b.life<=0||b.y<-40||b.x<-40||b.x>innerWidth+40)this.projectiles.release(b)});this.pickups.forEachActive(o=>{o.y+=this.scrollSpeed*dt*(o.kind==='microbe'?.08:.04);if(o.y>innerHeight+90||(o.flowAge>7&&o.y<-130))this.pickups.release(o)})}
